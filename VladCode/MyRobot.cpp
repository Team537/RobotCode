...
public:
	...
	void OperatorControl()
	{
		...
		while (IsOperatorControl())
		{
			...
			//Shoot.runShooter(PrimaryController.GetRawButton(SHOOT_BUTTON), PrimaryController.GetRawButton(FLY_WHEEL_TOGGLE), PrimaryController.GetRawButton(ANGLE_UP), PrimaryController.GetRawButton(ANGLE_DOWN), ShooterKind);
