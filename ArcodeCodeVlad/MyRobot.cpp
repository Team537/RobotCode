...
public:
	...
	void OperatorControl()
	{
		...
		while (IsOperatorControl())
		{
			...
			DriveTrain.RunDriveTrain(PrimaryController.GetRawAxis(JOYSTICK_FORWARD), PrimaryController.GetRawAxis(JOYSTICK_TWIST), (int)PrimaryController.GetRawButton(SHIFT_HIGH), (int)PrimaryController.GetRawButton(SHIFT_LOW));
