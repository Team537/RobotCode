...
public:
	...
	float LeftSpeed, RightSpeed, NewLeftSpeed, NewRightSpeed, LeftRatio, RightRatio;
...
private:
	...
	void RunClamping ();
	void RunEncoders ();
	void RunRampSpeed (float LeftNewSpeed, float RightNewSpeed, float Forward, float Twist);
	void RunDriveMotors ();
